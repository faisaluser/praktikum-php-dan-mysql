				 ...
				 <form method="post" action="edit_barang.php" enctype="mult ipart/form-data">  
					    ...
					    <div class="input">  
						        ...
						        <select name="kategori">  
							            <option value="Komputer" <?php echo is_select ('Komputer', $data['kategori']);?>>Komputer</option>              <option value="Elektronik" <?php echo is_select ('Elektronik', $data['kategori']);?>>Elektronik</option>  
